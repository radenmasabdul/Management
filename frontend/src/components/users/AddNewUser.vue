...
<template>
  <label @click="openModal" type="button" for="my_modal_6" class="btn btn-success btn-sm"
    ><span><font-awesome-icon :icon="['fas', 'plus']" style="color: #ffffff" /></span
  ></label>
